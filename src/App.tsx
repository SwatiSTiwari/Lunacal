        ...
        <div className="w-full max-w-[720px] space-y-6">
          ...
          <div className="bg-[#363C43] rounded-[18.89px] shadow-[5.67px_5.67px_3.78px_0px_rgba(0,0,0,0.4)] p-4">
            <div className="flex items-center gap-2 mb-6">
              <div className="relative">
                ...
                {/* Small 2x2 grid positioned under the Help icon and slightly left of center */}
                <div className="absolute left-1/2 -translate-x-2 top-full mt-10 w-6 h-6 grid grid-cols-2 gap-0.5">
              ...
              {/* existing right-side content remains (no extra grid here) */}
            </div>
          ...
          <div className="bg-[#363C43] rounded-[18.89px] shadow-[5.67px_5.67px_3.78px_0px_rgba(0,0,0,0.4)] p-4">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className="w-[45px] h-[45px] bg-gradient-to-b from-[#303439] to-[#161718] hover:from-[#3a3e43] hover:to-[#1f2123] rounded-full flex items-center justify-center shadow-[4px_5px_30px_5px_rgba(16,18,19,1),-5px_-3px_30px_-10px_rgba(150,190,231,1)] transition-all"
                  >
              ...
              {/* removed duplicate right-side grid; grid now sits under HelpCircle */}
            </div>
            ...
            <div className="flex gap-4 justify-start">
              {visibleImages.map((image, index) => (
                <div
                  ...
                  className="w-[190px] h-[179px] rounded-[24px] overflow-hidden transition-all duration-500 ease-in-out transform hover:scale-110 hover:rotate-0 hover:shadow-2xl"
                  style={{
                    transform: 'rotate(-1deg)',
                    filter: 'grayscale(100%) brightness(0.7)',
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.filter = 'grayscale(0%) brightness(1.2) contrast(1.1) saturate(1.2)';
                  }}
                  onMouseLeave={(e) => {
